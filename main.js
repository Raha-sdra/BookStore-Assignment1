...
function shoppingPage() {
  ...
  shoppingButton.addEventListener("click", (event) => {
   ...
   `;
    ...
    // before this step, filter shopping array, if elements repeat, count the number
    // also get that element
    // shopping = [[{"title": "dsa", "price": 123, "author": "whoever"}], [{}], [{}]]
    // compare the lists, if they are the same
    // for the total price, you need get the element.price * count number
    // for the final price, you need count all the books price and sum them
              ...
              <div class="row align-items-center">
                ...
                <div class="col-md-2 d-flex justify-content-center">
                  <div>
                    ...
                    <p class="lead fw-normal mb-0">${Number(book.Price.split('kr')[0]) * book.count} kr</p>
                  </div>
                </div>
